...
// Les étapes majeures, alignées sur le planning ajusté (artefact « Bajío,
// Barranca, Baja », 15 septembre 2026).
//
// Trois changements de fond par rapport à la version initiale : Puebla sort de
// la première étape et du voyage — deux vols directs depuis Los Cabos et une
// quatrième ville coloniale d'affilée ont fait préférer Guadalajara ; le retour
// de Basse Californie passe donc par Guadalajara du 12 au 14 octobre ; et
// l'étape de transition « Vers Oaxaca » disparaît, la côte oaxaqueña
// s'enchaînant directement au vol Guadalajara → Puerto Escondido.
export const STAGES = [
  { n: 1,  nom: "Mexico City",             debut: "2026-09-08", fin: "2026-09-15", couleur: "#FF3D7F" },
  { n: 2,  nom: "Le Bajío",                debut: "2026-09-16", fin: "2026-09-21", couleur: "#FF8A3D" },
  { n: 3,  nom: "Sierra Tarahumara",       debut: "2026-09-22", fin: "2026-09-27", couleur: "#E2563C" },
