// ⚠️ MODE TEST — répétition générale du 15 au 25 août 2026.
// Pour terminer le test : passer TEST_MODE à false (retire l'étape 0 et rétablit
// le vrai compteur « 100 jours »), puis supprimer les posts datés d'août.
export const TEST_MODE = true;
const TEST_STAGE = { n: 0, nom: "Répétition générale", debut: "2026-08-15", fin: "2026-08-25", couleur: "#7A8B99" };
...
// L'étape 0 de test est prépendée uniquement quand TEST_MODE est activé.
export const STAGES = TEST_MODE ? [TEST_STAGE, ...REAL_STAGES] : REAL_STAGES;
