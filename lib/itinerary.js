// Données du parcours, reprises de l'artefact parcours-mexique. Les dates n'y
// figurent pas : elles viennent des étapes (lib/stages.js), appariées par rang.
export const SPLIT = [];

export const PHASES = [
  {
    id: 'cdmx', num: 1, title: 'Mexico City', color: '#E0177D', emoji: '🏛️',
    cities: [
  ...
  {
    id: 'bajio', num: 2, title: 'Le Bajío', color: '#9D6BD4', emoji: '🎨',
    cities: [
  ...
  {
    id: 'cuivre', num: 3, title: 'Sierra Tarahumara', color: '#3FA565', emoji: '⛰️',
    cities: [
  ...
  {
    id: 'baja', num: 4, title: 'Basse Californie', color: '#2EB8CC', emoji: '🌊',
    cities: [
  ...
  {
    id: 'guadalajara', num: 5, title: 'Guadalajara', color: '#A8763C', emoji: '🎺',
    cities: [
  ...
  {
    id: 'pacifique', num: 6, title: 'Côte oaxaqueña', color: '#1EC2B0', emoji: '🌴',
    cities: [
  ...
  {
    id: 'oaxaca', num: 7, title: 'Oaxaca & Día de los Muertos', color: '#F2941E', emoji: '💀',
    cities: [
  ...
  {
    id: 'chiapas', num: 8, title: 'Chiapas', color: '#5FAE3F', emoji: '🌳',
    cities: [
  ...
  {
    id: 'yucatan', num: 9, title: 'Yucatán élargi', color: '#3E8FE0', emoji: '💧',
    cities: [
  ...
  {
    id: 'belize', num: 10, title: 'Belize', color: '#22C2D6', emoji: '🐠',
    cities: [
  ...
  {
    id: 'guatemala', num: 11, title: 'Guatemala', color: '#D87A4A', emoji: '🌋',
    cities: [
  ...
  {
    id: 'salvador', num: 12, title: 'Salvador', color: '#E84855', emoji: '☀️',
    cities: [
