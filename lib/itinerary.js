...
export const PHASES = [
  {
    id: 'cdmx', num: 1, title: 'Mexico City', dates: '8 – 15 sept', days: 8, color: '#E0177D', emoji: '🏛️',
    cities: [
    ...
    poi: {
      ...
      'Gastronomie': ['Mercado de San Juan', 'Tacos al pastor de quartier', 'Pulquerías traditionnelles du centre', 'Café de Tacuba pour un déjeuner historique'],
      'Marché & artisanat': ['Marché de Coyoacán le week-end', 'Mercado de Artesanías La Ciudadela'],
    },
    highlights: ['Montgolfière au lever du jour sur Teotihuacán', "Soirée lucha libre à l'Arena México", "Quartiers Roma/Condesa pour l'ambiance locale", 'Vue panoramique depuis la Torre Latinoamericana', 'Plaza de las Tres Culturas à Tlatelolco', "Marché de Sonora pour l'ambiance ésotérique"],
  ...
  {
    id: 'bajio', num: 2, title: 'Le Bajío', dates: '16 – 21 sept', days: 6, color: '#9D6BD4', emoji: '🎨',
    cities: [
  ...
  {
    id: 'cuivre', num: 3, title: 'Sierra Tarahumara', dates: '22 – 27 sept', days: 6, color: '#3FA565', emoji: '⛰️',
    cities: [
  ...
  {
    id: 'baja', num: 4, title: 'Basse Californie', dates: '28 sept – 11 oct', days: 14, color: '#2EB8CC', emoji: '🌊',
    cities: [
      ...
      { name: 'San José del Cabo', lat: 23.0614, lng: -109.701 },
    ],
    poi: {
      'Plage & mer': ['Cabo Pulmo — récif corallien protégé', 'Playa Balandra', 'Isla Espíritu Santo', 'Playa El Tecolote'],
      'Histoire & culture': ["Todos Santos — galeries d'art, Hotel California", 'Malecón de La Paz', 'San José del Cabo — centro histórico et Barrio del Arte'],
      'Nature': ['Estero de San José — lagune et oiseaux', 'Sierra de la Laguna — contreforts et fermes bio'],
      'Gastronomie': ['Marché de producteurs de La Paz', 'Tacos de poisson à Todos Santos', 'Mariscos frais sur le Malecón'],
    },
    highlights: ['Nager avec les lions de mer à Isla Espíritu Santo', "Plongée à Cabo Pulmo, un des meilleurs récifs d'Amérique du Nord", 'Coucher de soleil à Balandra', 'Surf à Los Cerritos', 'Balade à vélo sur le Malecón de La Paz au coucher du soleil', 'Dernière soirée dans le Barrio del Arte de San José del Cabo'],
    tips: ["Cabo Pulmo n'a aucune liaison directe : sans voiture, le transfert privé se réserve à l'avance par l'hébergement, dans les deux sens — le dernier tronçon est une piste, et le village n'a ni distributeur ni réseau fiable", "Otaries de Los Islotes : la colonie rouvre le 1er septembre après la reproduction, septembre–mai est la bonne fenêtre — la sortie Espíritu Santo se réserve, c'est le sommet de l'étape", "Requins-baleines : la saison ouvre le 1er octobre mais les sorties ne démarrent qu'à la mi-novembre, et les baleines grises sont un rendez-vous de janvier–mars. Ne rien construire dessus", "Fin de saison cyclonique : la mer est encore à 26–28 °C, mais prévoir quelques jours de pluie et des sorties en mer annulées — réservations annulables et assurance", "Cabo San Lucas, très touristique et cher, peut être sauté au profit de Cabo Pulmo et Todos Santos, plus proches de votre style de voyage"],
    eat: [
      ...
      { name: "Flora's Field Kitchen", type: 'resto', note: 'Sélectionné au 50 Best Discovery', desc: 'Ferme bio dans les contreforts de la Sierra de la Laguna, au-dessus de San José : tout sort du potager et du ranch, pizzas au feu de bois et musique live la plupart des soirs.' },
      { name: 'La Lupita Taco & Mezcal', type: 'resto', note: 'Au cœur du Barrio del Arte', desc: 'Tacos créatifs, tortillas fraîches et longue carte de mezcal, dans le quartier des galeries de San José del Cabo.' },
    ],
  },
  {
    id: 'guadalajara', num: 5, title: 'Guadalajara', dates: '12 – 14 oct', days: 3, color: '#A8763C', emoji: '🎺',
    cities: [
      { name: 'Guadalajara', lat: 20.6596988, lng: -103.3496092 },
      { name: 'Tlaquepaque', lat: 20.6409, lng: -103.2936 },
      { name: 'Tequila', lat: 20.8801, lng: -103.8369 },
    ],
    poi: {
      'Histoire & culture': ['Hospicio Cabañas et les murales de José Clemente Orozco', 'Cathédrale et Plaza de Armas', 'Teatro Degollado', 'Rotonda de los Jaliscienses Ilustres'],
      'Nature': ["Paysages d'agave de Tequila, classés à l'UNESCO", 'Barranca de Huentitán'],
      'Gastronomie': ['Mercado San Juan de Dios', 'Tortas ahogadas, la spécialité de la ville', 'Birria de Jalisco', "Distillerie de tequila sur le chemin d'agave"],
      'Marché & artisanat': ['Ateliers de céramique de Tlaquepaque', 'Tonalá le jeudi et le dimanche'],
    },
    highlights: ["Les murales d'Orozco sous la coupole de l'Hospicio Cabañas", 'Mariachis Plaza de los Mariachis en fin de soirée', "Tlaquepaque l'après-midi, entre galeries et patios", "Journée à Tequila : le village, une distillerie, les champs d'agave bleu"],
    tips: ["Trois vols directs par jour depuis Los Cabos : aucune contrainte de date à l'arrivée", "Vol quotidien Volaris vers Puerto Escondido à 11:08 pour la suite : c'est ce qui fait de Guadalajara la meilleure sortie de la péninsule", 'Le centre se fait à pied et en métro ; Tlaquepaque est à 20 min en taxi'],
    eat: [
      { name: 'Alcalde', type: 'resto', note: 'La table de référence', desc: 'Cuisine mexicaine contemporaine de Paco Ruano, régulièrement citée parmi les meilleures du pays.' },
      { name: 'Karne Garibaldi', type: 'resto', note: 'Record du monde de rapidité', desc: 'Une seule recette, la carne en su jugo, servie en moins d\u2019une minute depuis 1970.' },
      { name: 'Tortas Ahogadas El Prieto', type: 'resto', note: 'La spécialité locale', desc: 'La torta noyée dans sa sauce tomate pimentée, à manger debout et les mains mouillées.' },
      { name: 'Pare de Sufrir', type: 'bar', note: 'Cantina de quartier', desc: "Mezcal et ambiance tapatía dans le centre, pour la soirée d'avant-départ." },
    ],
  },
  {
    id: 'pacifique', num: 6, title: 'Côte oaxaqueña', dates: '15 – 27 oct', days: 13, color: '#1EC2B0', emoji: '🌴',
    cities: [
  ...
  {
    id: 'oaxaca', num: 7, title: 'Oaxaca & Día de los Muertos', dates: '28 oct – 2 nov', days: 6, color: '#F2941E', emoji: '💀',
    cities: [
  ...
  {
    id: 'chiapas', num: 8, title: 'Chiapas', dates: '3 – 11 nov', days: 9, color: '#5FAE3F', emoji: '🌳',
    cities: [
  ...
  {
    id: 'yucatan', num: 9, title: 'Yucatán élargi', dates: '12 – 25 nov', days: 14, color: '#3E8FE0', emoji: '💧',
    cities: [
  ...
  {
    id: 'belize', num: 10, title: 'Belize', dates: '26 nov – 2 déc', days: 7, color: '#22C2D6', emoji: '🐠',
    cities: [
  ...
  {
    id: 'guatemala', num: 11, title: 'Guatemala', dates: '3 – 12 déc', days: 10, color: '#D87A4A', emoji: '🌋',
    cities: [
  ...
  {
    id: 'salvador', num: 12, title: 'Salvador', dates: '13 – 17 déc', days: 5, color: '#E84855', emoji: '☀️',
    cities: [
