...
// moto-taxi, stop.
// `cumul` complète « km … » dans les compteurs du voyage : « km en bus ».
export const MODES = [
  { id: "bus", label: "Bus", ic: "🚌", cumul: "en bus" },
  { id: "train", label: "Train", ic: "🚆", cumul: "en train" },
  { id: "avion", label: "Avion", ic: "✈️", cumul: "en avion" },
  { id: "bateau", label: "Bateau", ic: "⛴️", cumul: "en bateau" },
  { id: "taxi", label: "Taxi", ic: "🚕", cumul: "en taxi" },
  { id: "autre", label: "Autre", ic: "🛺", cumul: "autrement" },
];
